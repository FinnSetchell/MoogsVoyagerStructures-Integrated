...
- Villagers now spawn in the large cart and barn structures — their villager jigsaws pointed at a structure pool that does not exist, so no villagers were placed.
