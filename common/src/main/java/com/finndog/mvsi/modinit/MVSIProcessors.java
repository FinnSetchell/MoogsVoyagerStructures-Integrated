 ...
 * on Forge — where the vanilla {@code BuiltInRegistries} are frozen before the mod constructor runs,
 * so a direct {@code Registry.register} there throws "Registry is already frozen".
 */
public final class MVSIProcessors {

    public static final ResourceLocation MOD_COMPAT_REPLACE_ID =
            new ResourceLocation(MVSICommon.MODID, "mod_compat_replace");
